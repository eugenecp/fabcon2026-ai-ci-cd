...
│   ├── validate-transformations.ps1 ........ YAML transformation validator
│   ├── validate-semantic-models.ps1 ........ Best Practice Analyzer
...
│   ├── .bpaRules.json ...................... Custom BPA rules config
│   │
│   └── validators/ (5 files)
...
| **validate-transformations.ps1** | ~8 KB | YAML transformation validator (DBML checks) | CI Pipeline |
| **validate-semantic-models.ps1** | ~10 KB | Best Practice Analyzer for semantic models | CI Pipeline |
...
| **.bpaRules.json** | ~15 KB | Custom BPA rules for semantic models | validate-semantic-models.ps1 |
...
**Total Files in Package:** 43 files (~375 KB uncompressed, ~105-115 KB zipped)
